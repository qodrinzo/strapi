...
Use the CLI, and run the following command `strapi generate:api user firstname:string lastname:string`. Read the [CLI documentation](../cli/CLI.md) for more informations.
